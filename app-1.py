...
with st.sidebar:
    ...
    img_path = r'C:\Users\m14Z352\Desktop\資安\analysis_result.png'
...
@st.cache_resource
def load_and_train():
    file_path = r'C:\Users\m14Z352\Desktop\資安\phishing_small.csv'
    df = pd.read_csv(file_path).dropna(subset=['text_combined'])
